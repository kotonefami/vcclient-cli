...
def main():
    ...
    parser.add_argument("--input-type", type=str, default="file", choices=["file", "ffmpeg", "ogg_opus", "rtp_opus", "discord", "device"], help="Input type ('file', 'ffmpeg', 'ogg_opus', 'rtp_opus', 'discord', or 'device')")
    ...
    parser.add_argument("--input-port", type=int, default=20012, help="UDP port for OggOpus or RtpOpus input (default: 20012)")
    parser.add_argument("--input-payload-type", type=int, default=120, help="RTP payload type for RtpOpus input (default: 120)")
